...
export default function FertelsaPage() {
  ...
  const benefits = [
    ...
    "Helps maintain healthy insulin metabolism",
    "Supports normal ovarian function",
    "Promotes reproductive wellness",
    "Supports gut and vaginal microbiome balance",
    "Helps maintain overall women's health"
  ]

  const ingredients = [
    { name: "Myo-Inositol", amount: "2000 mg" },
    { name: "D-Chiro-Inositol", amount: "50 mg" },
    { name: "Lactobacillus rhamnosus", amount: "2 Billion CFU" },
    { name: "Lactobacillus reuteri", amount: "2 Billion CFU" },
    { name: "Inulin", amount: "100 mg" },
    { name: "Chromium Picolinate III", amount: "200 mcg" }
  ]
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Advanced Nutraceutical Support for Women's Reproductive Wellness
            </p>
            <p className="text-base text-muted-foreground leading-relaxed">
              Fertelsa Sachet is a scientifically formulated nutraceutical designed to support women with reproductive wellness needs by combining the physiological 40:1 ratio of Myo-Inositol and D-Chiro-Inositol with probiotics, prebiotics, and essential micronutrients. The formula is developed to promote metabolic balance and overall reproductive health.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative h-96 lg:h-[500px] bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center p-8">
                <Image
                  src="/images/products/fertelsa.png"
                  alt="Fertelsa Sachet"
                  width={300}
                  height={400}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Our comprehensive formulation combines inositols, probiotics, a prebiotic, and chromium to provide multi-dimensional nutritional support for women's reproductive and metabolic wellness in a convenient once-daily sachet.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Mix one sachet in approximately 150–200 mL of water and consume once daily, or as directed by your healthcare professional.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xs text-muted-foreground leading-relaxed">
              This product is a nutraceutical/food supplement and is not intended to diagnose, treat, cure, or prevent any disease. Consult your healthcare professional before use, especially during pregnancy or if you have any underlying medical conditions.
            </p>
          </div>
        </div>
      </section>
